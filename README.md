...
3. **Download or auto-publish — your choice per upload.** The default is **manual**: nothing is posted; download clips one by one or as an organized **ZIP** (numbered parts named by their hook titles, a ready-to-paste caption `.txt` beside every clip, and a README). Tick *Auto-publish* at upload and instead Part 1 posts as soon as processing finishes, with every following part **3 hours** later, to *all* connected accounts.
